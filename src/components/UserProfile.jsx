// Allows users to manage their crop profile by selecting crops they grow.
// Saves preferences locally or to the server.
        ...
        <div className="min-h-screen bg-[#1a1a1a] text-white p-4">
            <div className="max-w-2xl mx-auto">
                ...
                <div className="flex items-center gap-4 mb-8 pt-4">
                    ...
                    <h1 className="text-2xl font-bold">My Crop Profile</h1>
                ...
                <div className="space-y-6">
                    <div className="bg-[#242424] p-6 rounded-2xl border border-white/5">
                        <div className="mb-6">
                            <h2 className="text-lg font-semibold mb-2">What do you grow?</h2>
                            <p className="text-gray-400 text-sm">
                                Select the crops you want to track. This helps us provide better diagnosis accuracy.
                            </p>
                        </div>
